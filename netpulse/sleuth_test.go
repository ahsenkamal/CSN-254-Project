...
func TestClientDoClosed(t *testing.T) {
	...
	c := newClient(GROUP, nil, log)
	c.closed = true
	req, _ := http.NewRequest("POST", "netpulse://foo/bar", nil)
	_, err := c.Do(req)
	if err == nil {
...
func TestClientDoTimeout(t *testing.T) {
	...
	req, _ := http.NewRequest("POST", "netpulse://"+service+"/", nil)
	_, err := c.Do(req)
	if err == nil {
...
func TestnetpulseNewBadInterface(t *testing.T) {
...
func TestnetpulseNewBadLogLevel(t *testing.T) {
...
func TestnetpulseNewBadPort(t *testing.T) {
...
func TestnetpulseNewBadService(t *testing.T) {
